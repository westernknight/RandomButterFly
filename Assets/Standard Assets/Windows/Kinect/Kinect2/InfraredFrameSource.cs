...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<InfraredFrameSource>(_pNative);
        ...
        private static void Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler(RootSystem.IntPtr result, RootSystem.IntPtr pNative)
        {
            ...
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<InfraredFrameSource>(pNative);
        ...
        public Windows.Kinect2.InfraredFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("InfraredFrameSource");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.InfraredFrameReader>(objectPointer, n => new Windows.Kinect2.InfraredFrameReader(n));
        }
