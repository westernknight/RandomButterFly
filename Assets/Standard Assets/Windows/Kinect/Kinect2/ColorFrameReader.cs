...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<ColorFrameReader>(_pNative);
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.ColorFrameArrivedEventArgs>>> Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.ColorFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect2.ColorFrameArrivedEventArgs>> callbackList = null;
            Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(pNative, out callbackList);
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<ColorFrameReader>(pNative);
                var args = new Windows.Kinect2.ColorFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.Kinect2.ColorFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public Windows.Kinect2.ColorFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("ColorFrameReader");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.ColorFrame>(objectPointer, n => new Windows.Kinect2.ColorFrame(n));
        }
