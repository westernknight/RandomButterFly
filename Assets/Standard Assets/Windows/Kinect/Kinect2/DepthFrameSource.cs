...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<DepthFrameSource>(_pNative);
        ...
        private static void Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler(RootSystem.IntPtr result, RootSystem.IntPtr pNative)
        {
            ...
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<DepthFrameSource>(pNative);
        ...
        public Windows.Kinect2.DepthFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("DepthFrameSource");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.DepthFrameReader>(objectPointer, n => new Windows.Kinect2.DepthFrameReader(n));
        }
