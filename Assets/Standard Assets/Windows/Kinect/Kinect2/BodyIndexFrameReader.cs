...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<BodyIndexFrameReader>(_pNative);
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.BodyIndexFrameArrivedEventArgs>>> Windows_Kinect_BodyIndexFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.BodyIndexFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect2.BodyIndexFrameArrivedEventArgs>> callbackList = null;
            Windows_Kinect_BodyIndexFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(pNative, out callbackList);
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<BodyIndexFrameReader>(pNative);
                var args = new Windows.Kinect2.BodyIndexFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.Kinect2.BodyIndexFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public Windows.Kinect2.BodyIndexFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("BodyIndexFrameReader");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.BodyIndexFrame>(objectPointer, n => new Windows.Kinect2.BodyIndexFrame(n));
        }
