...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<AudioBeamFrameReader>(_pNative);
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.AudioBeamFrameArrivedEventArgs>>> Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.AudioBeamFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect2.AudioBeamFrameArrivedEventArgs>> callbackList = null;
            Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(pNative, out callbackList);
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<AudioBeamFrameReader>(pNative);
                var args = new Windows.Kinect2.AudioBeamFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.Kinect2.AudioBeamFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public RootSystem.Collections.Generic.IList<Windows.Kinect2.AudioBeamFrame> AcquireLatestBeamFrames()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("AudioBeamFrameReader");
            ...
            var managedCollection = new Windows.Kinect2.AudioBeamFrame[outCollectionSize];
            ...
            for(int i=0;i<outCollectionSize;i++)
            {
                ...
                var obj = Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.AudioBeamFrame>(outCollection[i], n => new Windows.Kinect2.AudioBeamFrame(n));
