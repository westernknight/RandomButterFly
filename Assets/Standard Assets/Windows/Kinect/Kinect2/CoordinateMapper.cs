...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<CoordinateMapper>(_pNative);
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.CoordinateMappingChangedEventArgs>>> Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.CoordinateMappingChangedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect2.CoordinateMappingChangedEventArgs>> callbackList = null;
            Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate_callbacks.TryGetValue(pNative, out callbackList);
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<CoordinateMapper>(pNative);
                var args = new Windows.Kinect2.CoordinateMappingChangedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.Kinect2.CoordinateMappingChangedEventArgs> CoordinateMappingChanged
        {
            add
            {
        ...
        // Public Methods
        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapCameraPointToDepthSpace(RootSystem.IntPtr pNative, Windows.Kinect2.CameraSpacePoint cameraPoint);
        public Windows.Kinect2.DepthSpacePoint MapCameraPointToDepthSpace(Windows.Kinect2.CameraSpacePoint cameraPoint)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var obj = (Windows.Kinect2.DepthSpacePoint)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.Kinect2.DepthSpacePoint));
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }

        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapCameraPointToColorSpace(RootSystem.IntPtr pNative, Windows.Kinect2.CameraSpacePoint cameraPoint);
        public Windows.Kinect2.ColorSpacePoint MapCameraPointToColorSpace(Windows.Kinect2.CameraSpacePoint cameraPoint)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
            ...
            Helper.ExceptionHelper.CheckLastError();
            var obj = (Windows.Kinect2.ColorSpacePoint)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.Kinect2.ColorSpacePoint));
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }

        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapDepthPointToCameraSpace(RootSystem.IntPtr pNative, Windows.Kinect2.DepthSpacePoint depthPoint, ushort depth);
        public Windows.Kinect2.CameraSpacePoint MapDepthPointToCameraSpace(Windows.Kinect2.DepthSpacePoint depthPoint, ushort depth)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
            ...
            Helper.ExceptionHelper.CheckLastError();
            var obj = (Windows.Kinect2.CameraSpacePoint)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.Kinect2.CameraSpacePoint));
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }

        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapDepthPointToColorSpace(RootSystem.IntPtr pNative, Windows.Kinect2.DepthSpacePoint depthPoint, ushort depth);
        public Windows.Kinect2.ColorSpacePoint MapDepthPointToColorSpace(Windows.Kinect2.DepthSpacePoint depthPoint, ushort depth)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapCameraPointsToDepthSpace(Windows.Kinect2.CameraSpacePoint[] cameraPoints, Windows.Kinect2.DepthSpacePoint[] depthPoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapCameraPointsToColorSpace(Windows.Kinect2.CameraSpacePoint[] cameraPoints, Windows.Kinect2.ColorSpacePoint[] colorPoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthPointsToCameraSpace(Windows.Kinect2.DepthSpacePoint[] depthPoints, ushort[] depths, Windows.Kinect2.CameraSpacePoint[] cameraPoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthPointsToColorSpace(Windows.Kinect2.DepthSpacePoint[] depthPoints, ushort[] depths, Windows.Kinect2.ColorSpacePoint[] colorPoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthFrameToCameraSpace(ushort[] depthFrameData, Windows.Kinect2.CameraSpacePoint[] cameraSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthFrameToColorSpace(ushort[] depthFrameData, Windows.Kinect2.ColorSpacePoint[] colorSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapColorFrameToDepthSpace(ushort[] depthFrameData, Windows.Kinect2.DepthSpacePoint[] depthSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapColorFrameToCameraSpace(ushort[] depthFrameData, Windows.Kinect2.CameraSpacePoint[] cameraSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
