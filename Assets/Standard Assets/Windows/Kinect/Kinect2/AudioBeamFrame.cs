...
namespace Windows.Kinect2
{
...

    {
        ...
        public  Windows.Kinect2.AudioBeam AudioBeam
        {
            get
            {
                ...
                return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.AudioBeam>(objectPointer, n => new Windows.Kinect2.AudioBeam(n));
            }
        }
