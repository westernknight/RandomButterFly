...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<AudioSource>(_pNative);
        ...
        public  RootSystem.Collections.Generic.IList<Windows.Kinect2.AudioBeam> AudioBeams
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                var managedCollection = new Windows.Kinect2.AudioBeam[outCollectionSize];
                ...
                for(int i=0;i<outCollectionSize;i++)
                {
                    ...
                    var obj = Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.AudioBeam>(outCollection[i], n => new Windows.Kinect2.AudioBeam(n));
        ...
        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern Windows.Kinect2.KinectAudioCalibrationState Windows_Kinect_AudioSource_get_AudioCalibrationState(RootSystem.IntPtr pNative);
        public  Windows.Kinect2.KinectAudioCalibrationState AudioCalibrationState
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        private static void Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler(RootSystem.IntPtr result, RootSystem.IntPtr pNative)
        {
            ...
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<AudioSource>(pNative);
        ...
        public Windows.Kinect2.AudioBeamFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("AudioSource");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.AudioBeamFrameReader>(objectPointer, n => new Windows.Kinect2.AudioBeamFrameReader(n));
        }
