...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<BodyFrame>(_pNative);
        ...
        public  Windows.Kinect2.Vector4 FloorClipPlane
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                Helper.ExceptionHelper.CheckLastError();
                var obj = (Windows.Kinect2.Vector4)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.Kinect2.Vector4));
                Windows.Kinect2.KinectUnityAddinUtils.FreeMemory(objectPointer);
                return obj;
            }
        }
