...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<MultiSourceFrameReader>(_pNative);
        ...
        // Public Properties
        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern Windows.Kinect2.FrameSourceTypes Windows_Kinect_MultiSourceFrameReader_get_FrameSourceTypes(RootSystem.IntPtr pNative);
        public  Windows.Kinect2.FrameSourceTypes FrameSourceTypes
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.MultiSourceFrameArrivedEventArgs>>> Windows_Kinect_MultiSourceFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.MultiSourceFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect2.MultiSourceFrameArrivedEventArgs>> callbackList = null;
            Windows_Kinect_MultiSourceFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(pNative, out callbackList);
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<MultiSourceFrameReader>(pNative);
                var args = new Windows.Kinect2.MultiSourceFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.Kinect2.MultiSourceFrameArrivedEventArgs> MultiSourceFrameArrived
        {
            add
            {
        ...
        public Windows.Kinect2.MultiSourceFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("MultiSourceFrameReader");
