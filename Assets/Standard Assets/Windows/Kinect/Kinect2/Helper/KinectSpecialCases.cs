...
namespace Windows.Kinect2
{
    ...
    public sealed partial class AudioBeamSubFrame
    {
        ...
        public Windows.Kinect2.KinectBuffer LockAudioBuffer()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("AudioBeamSubFrame");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.KinectBuffer>(objectPointer, n => new Windows.Kinect2.KinectBuffer(n));
        }
    }

    public sealed partial class AudioBeamFrame
    {
        private Windows.Kinect2.AudioBeamSubFrame[] _subFrames = null;
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<AudioBeamFrame>(_pNative);
        ...
        public RootSystem.Collections.Generic.IList<Windows.Kinect2.AudioBeamSubFrame> SubFrames
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                if (_subFrames == null)
                {
                    ...
                    _subFrames = new Windows.Kinect2.AudioBeamSubFrame[collectionSize];
                    ...
                    for (int i = 0; i < collectionSize; i++)
                    {
                        ...
                        var obj = Helper.NativeObjectCache2.GetObject<Windows.Kinect2.AudioBeamSubFrame>(outCollection[i]);
                        if (obj == null)
                        {
                            obj = new Windows.Kinect2.AudioBeamSubFrame(outCollection[i]);
                            Helper.NativeObjectCache2.AddObject<Windows.Kinect2.AudioBeamSubFrame>(outCollection[i], obj);
                        }
    ...
    public sealed partial class BodyFrame
    {
        ...
        public void GetAndRefreshBodyData(RootSystem.Collections.Generic.IList<Windows.Kinect2.Body> bodies)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
    ...
    public sealed partial class Body
    {
        ...
        public Windows.Kinect2.PointF Lean
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                var obj = (Windows.Kinect2.PointF)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.Kinect2.PointF));
    ...
    public sealed partial class ColorFrame
    {
        ...
        [RootSystem.Runtime.InteropServices.DllImport(
            ...
            CallingConvention = RootSystem.Runtime.InteropServices.CallingConvention.Cdecl,
            SetLastError = true)]
        private static extern void Windows_Kinect_ColorFrame_CopyConvertedFrameDataToIntPtr(RootSystem.IntPtr pNative, IntPtr frameData, uint frameDataSize, Windows.Kinect2.ColorImageFormat colorFormat);
        public void CopyConvertedFrameDataToIntPtr(RootSystem.IntPtr frameData, uint size, Windows.Kinect2.ColorImageFormat colorFormat)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("ColorFrame");
        ...
        public Windows.Kinect2.KinectBuffer LockRawImageBuffer()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("ColorFrame");
    ...
    public sealed partial class DepthFrame
    {
        ...
        public Windows.Kinect2.KinectBuffer LockImageBuffer()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("DepthFrame");
    ...
    public sealed partial class KinectSensor
    {
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<KinectSensor>(_pNative);
    ...
    public sealed partial class CoordinateMapper
    {
        ...
        public Windows.Kinect2.CameraIntrinsics GetDepthCameraIntrinsics()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var obj = (Windows.Kinect2.CameraIntrinsics)RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(objectPointer, typeof(Windows.Kinect2.CameraIntrinsics));
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }
        ...
        public Windows.Kinect2.PointF[] GetDepthFrameToCameraSpaceTable()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
