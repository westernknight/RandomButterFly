...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<AudioBeamSubFrame>(_pNative);
        ...
        // Public Properties
        [RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern Windows.Kinect2.AudioBeamMode Windows_Kinect_AudioBeamSubFrame_get_AudioBeamMode(RootSystem.IntPtr pNative);
        public  Windows.Kinect2.AudioBeamMode AudioBeamMode
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public  RootSystem.Collections.Generic.IList<Windows.Kinect2.AudioBodyCorrelation> AudioBodyCorrelations
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                var managedCollection = new Windows.Kinect2.AudioBodyCorrelation[outCollectionSize];
                ...
                for(int i=0;i<outCollectionSize;i++)
                {
                    ...
                    var obj = Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.AudioBodyCorrelation>(outCollection[i], n => new Windows.Kinect2.AudioBodyCorrelation(n));
