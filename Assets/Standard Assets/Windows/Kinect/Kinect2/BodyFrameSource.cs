...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<BodyFrameSource>(_pNative);
        ...
        private static void Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler(RootSystem.IntPtr result, RootSystem.IntPtr pNative)
        {
            ...
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<BodyFrameSource>(pNative);
        ...
        public Windows.Kinect2.BodyFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("BodyFrameSource");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.BodyFrameReader>(objectPointer, n => new Windows.Kinect2.BodyFrameReader(n));
        }
