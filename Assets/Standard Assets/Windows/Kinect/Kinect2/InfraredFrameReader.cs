...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<InfraredFrameReader>(_pNative);
        ...
        private static Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.InfraredFrameArrivedEventArgs>>> Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<RootSystem.IntPtr, List<RootSystem.EventHandler<Windows.Kinect2.InfraredFrameArrivedEventArgs>>>();
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect2.InfraredFrameArrivedEventArgs>> callbackList = null;
            Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(pNative, out callbackList);
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<InfraredFrameReader>(pNative);
                var args = new Windows.Kinect2.InfraredFrameArrivedEventArgs(result);
        ...
        public  event RootSystem.EventHandler<Windows.Kinect2.InfraredFrameArrivedEventArgs> FrameArrived
        {
            add
            {
        ...
        public Windows.Kinect2.InfraredFrame AcquireLatestFrame()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("InfraredFrameReader");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.InfraredFrame>(objectPointer, n => new Windows.Kinect2.InfraredFrame(n));
        }
