...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<AudioBeamFrameArrivedEventArgs>(_pNative);
        ...
        public  Windows.Kinect2.AudioBeamFrameReference FrameReference
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.AudioBeamFrameReference>(objectPointer, n => new Windows.Kinect2.AudioBeamFrameReference(n));
            }
        }
