...
namespace Windows.Kinect2
{
...

    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache2.RemoveObject<BodyIndexFrameSource>(_pNative);
        ...
        private static void Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler(RootSystem.IntPtr result, RootSystem.IntPtr pNative)
        {
            ...
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache2.GetObject<BodyIndexFrameSource>(pNative);
        ...
        public Windows.Kinect2.BodyIndexFrameReader OpenReader()
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("BodyIndexFrameSource");
            ...
            return Helper.NativeObjectCache2.CreateOrGetObject<Windows.Kinect2.BodyIndexFrameReader>(objectPointer, n => new Windows.Kinect2.BodyIndexFrameReader(n));
        }
