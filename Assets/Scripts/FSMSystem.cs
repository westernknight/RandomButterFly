...
public abstract class FSMState
{
    ...
    public void AddTransition( StateID id)
    {
    ...
    /// </summary>
    public void DeleteTransition(StateID id)
    {
        ...
        Debug.LogError("FSMState ERROR: " + " passed to " + stateID.ToString() +
    ...
    /// </summary>
    public StateID GetOutputState(StateID id)
    {
...
public class FSMSystem
{
    ...
    /// </summary>
    public void PerformTransition(StateID inout)
    {
        
        // Check if the currentState has the transition passed as argument
        StateID id = currentState.GetOutputState(inout);
        if (id == StateID.NullStateID)
        {
