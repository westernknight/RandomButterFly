...
public class AvatarController : MonoBehaviour
{
    ...
    ///////////////////
    List<GameObject> cubeContainer = new List<GameObject>();

    GameObject Cube_Hip_Center;
    GameObject Cube_Spine;
    GameObject Cube_Neck;
    GameObject Cube_Head;
    GameObject Cube_Shoulder_Left;
    GameObject Cube_Elbow_Left;
    GameObject Cube_Wrist_Left;
    GameObject Cube_Hand_Left;
    GameObject Cube_Shoulder_Right;
    GameObject Cube_Elbow_Right;
    GameObject Cube_Wrist_Right;
    GameObject Cube_Hand_Right;
    GameObject Cube_Hip_Left;
    GameObject Cube_Knee_Left;
    GameObject Cube_Ankle_Left;
    GameObject Cube_Foot_Left;
    GameObject Cube_Hip_Right;
    GameObject Cube_Knee_Right;
    GameObject Cube_Ankle_Right;
    GameObject Cube_Foot_Right;
    GameObject Cube_Spine_Shoulder;
    GameObject Cube_Hand_Tip_Left;
    GameObject Cube_Thumb_Left;
    GameObject Cube_Hand_Tip_Right;
    GameObject Cube_Thumb_Right;
    ...
    void InitCubes()
    {
        ...
        cubeContainer.Add(Cube_Hip_Center);
        cubeContainer.Add(Cube_Spine);
        cubeContainer.Add(Cube_Neck);
        cubeContainer.Add(Cube_Head);
        cubeContainer.Add(Cube_Shoulder_Left);
        cubeContainer.Add(Cube_Elbow_Left);
        cubeContainer.Add(Cube_Wrist_Left);
        cubeContainer.Add(Cube_Hand_Left);
        cubeContainer.Add(Cube_Shoulder_Right);
        cubeContainer.Add(Cube_Elbow_Right);
        cubeContainer.Add(Cube_Wrist_Right);
        cubeContainer.Add(Cube_Hand_Right);
        cubeContainer.Add(Cube_Hip_Left);
        cubeContainer.Add(Cube_Knee_Left);
        cubeContainer.Add(Cube_Ankle_Left);
        cubeContainer.Add(Cube_Foot_Left);
        cubeContainer.Add(Cube_Hip_Right);
        cubeContainer.Add(Cube_Knee_Right);
        cubeContainer.Add(Cube_Ankle_Right);
        cubeContainer.Add(Cube_Foot_Right);
        cubeContainer.Add(Cube_Spine_Shoulder);
        cubeContainer.Add(Cube_Hand_Tip_Left);
        cubeContainer.Add(Cube_Thumb_Left);
        cubeContainer.Add(Cube_Hand_Tip_Right);
        cubeContainer.Add(Cube_Thumb_Right);

        for (int i = 0; i < cubeContainer.Count; i++)
        {
            cubeContainer[i] = GameObject.CreatePrimitive(PrimitiveType.Cube);
            cubeContainer[i].transform.parent = transform;
            cubeContainer[i].transform.localScale = Vector3.one * 0.07f;
        }
    }
    void UpdateCubes(Int64 userID)
    {


        List<GameObject> bones = cubeContainer;
    ...
    public void UpdateAvatar(Int64 UserID)
    {
        ...
        if (ik != null)
        {
            ...
            ik.solver.GetEffector(FullBodyBipedEffector.LeftHand).position = HandLeft.position;
            ik.solver.GetEffector(FullBodyBipedEffector.RightHand).position = HandRight.position;

            ik.solver.GetEffector(FullBodyBipedEffector.LeftFoot).position = FootLeft.position;
            ik.solver.GetEffector(FullBodyBipedEffector.RightFoot).position = FootRight.position;
        }
    }
    ...
    void MoveAvatar(Int64 UserID)
    {
        ...
        if (BodyRoot != null && BodyRoot.parent != null &&false)
        {
        ...
        else
        {
            ...
            offsetPosition = transform.position - initialPosition; 
            offsetPosition.y = 0;
        }
    }
    ...
    public void CreateIkCube()
    {
        if (ik != null)
        {
            GameObject cube = GameObject.CreatePrimitive(PrimitiveType.Cube);
            cube.transform.parent = HandLeft;
            cube.transform.localScale = Vector3.one * 0.07f;
            cube.transform.localPosition = Vector3.zero;
            cube.transform.position = ik.solver.GetEffector(FullBodyBipedEffector.LeftHand).bone.transform.position;
        }
        if (ik != null)
        {
            GameObject cube = GameObject.CreatePrimitive(PrimitiveType.Cube);
            cube.transform.parent = HandRight;
            cube.transform.localScale = Vector3.one * 0.07f;
            cube.transform.localPosition = Vector3.zero;
            cube.transform.position = ik.solver.GetEffector(FullBodyBipedEffector.RightHand).bone.transform.position;
        }
    }
